...
import com.boileradvsr.backend.email.EventNotifSender;
import com.boileradvsr.backend.models.Event;
...
public class EventReminderService {
    ...
    @Autowired
    public EventNotifSender eventNotifSender;
    ...
    private String buildEmail(String name, Event event, String link) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "                      <span style=\"font-family:Helvetica,Arial,sans-serif;font-weight:700;color:#ffffff;text-decoration:none;vertical-align:top;display:inline-block\">Upcoming event soon!</span>\n" +
                "                    </td>\n" +
                "                  </tr>\n" +
                "                </tbody></table>\n" +
                "              </a>\n" +
